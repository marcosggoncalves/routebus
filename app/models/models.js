class Models {
	...
	bairros(callback) {
		this.connection.query('select*from bairros, linhas where  bairros.id_linha = linhas.id_linha', callback);
	}
	horario(callback) {
		this.connection.query('select*from horarios', callback);
	}
	...
	horarios(id_bairro, filter_time, callback) {
		this.connection.query('SELECT * FROM horarios,linhas,bairros,sentidovia,classificacao,classificacao_horario where horarios.id_sentido = sentidovia.id_sentidovia and horarios.id_bairro = bairros.id_bairro and bairros.id_linha = linhas.id_linha and classificacao_horarios.id_horario = horarios.id_horario and classificacao_horarios.id_classificacao = classificacao.id_classificacao and bairros.id_bairro =?  and  classificacao.nome_classificacao ="' + filter_time + '" ', id_bairro, callback);
	}
	horarios_bairro(id_bairro, callback) {
		this.connection.query('SELECT * FROM horario,linhas,bairros,sentidovia,classificacao,classificacao_horario where horarios.id_sentido = sentidovia.id_sentidovia and horarios.id_bairro = bairros.id_bairro and bairros.id_linha = linhas.id_linha and classificacao_horarios.id_horario = horarios.id_horario and classificacao_horarios.id_classificacao = classificacao.id_classificacao and bairros.id_bairro =? ', id_bairro, callback)
	}
	pontos(id_bairro, callback) {
		this.connection.query('select*from bairros,linhas,pontos,ruas where  bairros.id_linha = linhas.id_linha and pontos.id_bairro = bairros.id_bairro and pontos.id_rua = ruas.id_rua and bairros.id_bairro="' + id_bairro + '" ', callback);
	}
	pontos_todos(callback) {
		this.connection.query('select*from bairros,linhas,pontos,ruas where  bairros.id_linha = linhas.id_linha and pontos.id_bairro = bairros.id_bairro and pontos.id_rua = ruas.id_rua', callback);
	}
	...
	insert_linha(linhas, callback) {
		this.connection.query('insert into linhas set ?', linhas, callback);
	}
	...
	insert_horario(horario, callback) {
		this.connection.query('insert into horarios set ?', horario, callback);
	}
